...
import 'onboarding/style.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'maps/kiosks_map_data.dart';
...
void main() {
  ...
  getIt.registerSingleton<KiosksMapDataStream>(KiosksMapDataStream());
    ...
    return _isLogIn
        ? StreamBuilder<DocumentSnapshot>(
            ...
            builder: (BuildContext context,
              ...
              if (snapshot.hasData) {
                print(snapshot.data.data['salary']);
                return MyMoney(snapshot.data['salary']);
              } else {
                return Container();
              }
            })
